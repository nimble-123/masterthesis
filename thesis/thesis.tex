...
% Insert body
\input{chapters/40_blockchain}
\input{chapters/50_energy_industry}
\input{chapters/60_evaluation_use_cases}
\input{chapters/70_proof_of_concept}
\input{chapters/80_analysis}
