...
\textcolor{red}{Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.}
...
Dabei können solche \textit{Blockchain} Systeme unterschiedlich ausgeprägt sein. Dies zeigt sich zb. an der Art des Zugriffs, also wer darf Transaktionen lesen, wer darf sie schreiben. Außerdem kann der Mechanismus zur Konsensfindung je System anders sein.
...
Bei der Auswahl der Art einer \textit{Blockchain} trifft man auf zwei Widersprüche die nachfolgend kurz erläutert sind. Darauf folgt eine Betrachtung der Konfliktursachen.
...
\paragraph{Kryptografisches Hashing}$~~$\\
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{pictures/digital-signatures-create}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\linewidth]{pictures/digital-signatures-validate-positive}
